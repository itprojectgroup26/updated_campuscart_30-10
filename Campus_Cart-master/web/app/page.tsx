...
const faqs: { title: string; description: string }[] = [
  {
    title: "What does Campus Cart offer to students?",
    description:
      "Campus Cart provides a dedicated online marketplace where students can buy and sell used college essentials like textbooks, dorm supplies, stationery, and more. This platform helps students save money while promoting the reuse of valuable resources.",
  },
  {
    title: "How does Campus Cart promote sustainability?",
    description:
      "By encouraging students to buy and sell used items, Campus Cart helps reduce waste and the demand for new products. This promotes a culture of recycling and sustainability, contributing to a greener college experience.",
  },
  {
  ...
  {
    title: "How does Campus Cart ensure moderation for listings?",
    description:
      "Campus Cart employs admin moderation to review and approve listings before they go live. This process ensures that items meet the platform’s guidelines.",
  },
  {
    title: "Can admin remove inappropriate listings or content?",
    description:
      "Yes, admins have the authority to remove any listings or content that violate Campus Cart’s terms of service. This includes items that are inappropriate, prohibited, or misrepresent their condition.",
  },
  {
    title: "Does Campus Cart offer real-time chat for buyers and sellers?",
    description:
      "Yes, Campus Cart provides a built-in real-time chat feature that allows buyers and sellers to communicate directly. This enables quick negotiations and inquiries.",
  },
  {
  ...
  {
    title: "How are delivery details arranged on Campus Cart?",
    description:
  ...
  {
    title: "Does Campus Cart provide any delivery services?",
    description:
      "No, Campus Cart does not offer delivery services. The buyer and seller must discuss and agree on the mode of delivery via the platform’s real-time chat feature, ensuring flexibility based on their preferences.",
  },
];
